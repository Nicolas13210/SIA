...
static void initialize() {
  ...
  const double khepera3_matrix[9][2] = {{-5000, -5000},  {-20000, 40000}, {-30000, 50000}, {-70000, 70000}, {-60000, 70000},
                                        {-40000, 50000}, {-20000, 40000}, {-5000, -5000},  {-10000, -10000}};
...
int main() {
  ...
  while (wb_robot_step(time_step) != -1) {
    ...
    for (i = 0; i < 2; i++) {
      ...
      if(sensors_value[2]<max_distance && sensors_value[3]<max_distance && sensors_value[4]<max_distance && sensors_value[5]<max_distance){
        speed[0] = max_speed;
        speed[1] = max_speed;
      }
